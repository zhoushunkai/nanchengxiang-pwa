...
const App = {
  ...
  seedData: {
    ...
    users: [
      { id: 'u001', name: '管理员', role: '总部', area: '', storeId: '', store: '' },
      { id: 'u002', name: '刘畅', role: '线上稽核', area: '', storeId: '', store: '' },
      { id: 'u003', name: '马昕茹', role: '线上稽核', area: '', storeId: '', store: '' },
      { id: 'u004', name: '陶畅', role: '线上稽核', area: '', storeId: '', store: '' },
      { id: 'u005', name: '范晓明', role: '线下稽核', area: '', storeId: '', store: '' },
      { id: 'u006', name: '钱磊', role: '线下稽核', area: '', storeId: '', store: '' },
      { id: 'u007', name: '教练A', role: '区域教练', area: '经营一区', storeId: '', store: '' },
      { id: 'u008', name: '教练B', role: '区域教练', area: '上海', storeId: '', store: '' },
      { id: 'u009', name: '张三', role: '店长', area: '', storeId: 'FZ001', store: '方庄店' },
      { id: 'u010', name: '李四', role: '店长', area: '', storeId: 'WJ001', store: '望京店' },
      { id: 'u011', name: '王五', role: '店长', area: '', storeId: 'SLH001', store: '十里河店' },
      { id: 'u012', name: '赵六', role: '店长', area: '', storeId: 'SH001', store: '上海徐汇店' },
      { id: 'u013', name: '孙七', role: '店长', area: '', storeId: 'HD001', store: '海淀黄庄店' },
      { id: 'u014', name: '周八', role: '店长', area: '', storeId: 'DC001', store: '东城王府井店' }
    ],
    regionCoaches: [
